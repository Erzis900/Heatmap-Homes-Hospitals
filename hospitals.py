...
class Space():
    ...
    def hill_climb(self, maximum=None, image_prefix=None, log=False):
        ...
        self.hospital_path = list(self.hospitals)
        ...
        while maximum is None or count < maximum:
            ...
            # Move to a highest-valued neighbor
                ...
                self.hospital_path.append(list(self.hospitals)[0])
    ...
    def plot_heatmap(self, heatmap):
        ...
        for step in self.hospital_path:
            # print(step)
            plt.scatter(step[1], step[0], color='blue')
        plt.show()
...
s.plot_heatmap(s.generate_heatmap())